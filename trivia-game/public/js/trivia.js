...
document.querySelector("main").insertAdjacentHTML("afterbegin", welcomeHeadingHTML({ playerName, }));
...
socket.on("question", ({ answers, createdAt, playerName, question }) => {
    ...
    const questionTemplate = triviaForm.querySelector("#trivia-question-template").innerHTML;
